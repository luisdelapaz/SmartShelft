...
<html lang="zxx">
<head>
<title>Configuracion Alertas - Smart Shelft</title>
<!-- Meta tag Keywords -->
...
<div class="nav-links">	
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<div class="w3l-nav">
				<ul class="nav navbar-nav link-effect">
					...
					<li><a href="Mis gondolas.jsp" >Mis Gondolas</a></li>
			...
			<ul class="nav navbar-nav navbar-right">
      				<li><a href="index.jsp"><span class="glyphicon glyphicon-user"></span> Inicia Sesion</a></li>
	...
	<div class="container">
    <h1><center><span class="glyphicon glyphicon-bell"></span>Alertas</center></h1>
	<form>	
	<table class="table table-bordered" width="700" height="300" border="0" cellspacing="0" cellpadding="0" align="center">
  <tbody>
  	 <tr>
      <th>Id Alerta</th>
      <th>Id Gondola</th>
    ...
    <tr>
      ...
      <td>100</td>
      <td>50</td>
      <td>"La gondola esta en un 50% de stock"</td>
    </tr>
    <tr>
      <td>002</td>
      <td>001</td>
      <td>100</td>
      <td>15</td>
      <td>"La gondola esta en un 15% de stock"</td>
    </tr>
    <tr>
      <td>003</td>
      <td>002</td>
      <td>50</td>
      <td>25</td>
      <td>"La gondola esta en un 25% de stock"</td>
    </tr>
    <tr>
      <td>004</td>
      <td>002</td>
...
<table width="500"  heigth="100" align="center" border="0">
	<tbody>
		<tr>
    		<td align="right" ><button type="button" class="btn btn-success">Crear Alerta</button></td>
    	</tr>
	</tbody>
</table>
</form>
