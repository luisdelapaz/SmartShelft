...
<div class="nav-links">	
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			...
			<ul class="nav navbar-nav navbar-right">
      				<li><a href="index.html"><span class="glyphicon glyphicon-user"></span> Inicia Sesion</a></li>
      				<li><a href="index.html"><span class="glyphicon glyphicon-log-in"></span> Cerrar</a></li>
    			</ul>
		</div>
...
<div class="about" id="about">
    ...
    <div class="dropdown">
  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Secciones
...
<thead>
<tr>
	<th>Gondolas con criticidad de productos</th>
	<th> Gondola critica</th>
</tr>
</thead>
<tr>
		<td><img src="images/GraficoBarra.PNG"/></td>
        <td><img src="images/GraficoCircular.PNG"/></td>
</tr>
</table>
 <p>&nbsp;</p>
<table align="right" >
<tr>
	<td></td>
	<td> <a href="misgondolas.jsp"><input type="button" value="Asignarme"></a></td>
</tr>
</table>
    <p>&nbsp;</p>
  <p>&nbsp;</p>
