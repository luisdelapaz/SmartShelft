...
<html lang="zxx">
<head>
<title>Listado Alertas - Smart Shelft</title>
<!-- Meta tag Keywords -->
...
<div class="nav-links">	
  ...
  <tbody>
    ...
    <tr>
      <td>11:50</td>
      <td><a href="alertadescripcion.jsp">"La gondola esta en un 50% de stock"</a></td>
      <td>001</td>
    </tr>
    <tr>
      <td>10:00</td>
      <td>"La gondola esta en un 30% de stock"</td>
      <td>002</td>
    </tr>
    <tr>
      <td>09:00</td>
    ...
    <tr>
      <td>09:00</td>
      <td>"La gondola esta en un 40% de stock"</td>
      <td>006</td>
    </tr>
  </tbody>
</table>
<table width="400"  heigth="100" align="center" border="0">
	<tbody>
		<tr>
    	<td align="right"> <a href="crearalerta.jsp"><input type="button" value="Configurar alerta"></a></td>
    	</tr>
	</tbody>
</table>
</form>
