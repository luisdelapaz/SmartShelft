...
<html lang="zxx">
<head>
<title>Mis Gondolas - Smart Shelft</title>
<!-- Meta tag Keywords -->
...
<div class="nav-links">	
	...
	<div class="container">
    <h1><center>Mis Gondolas</center></h1>
    <form>
    	 <div class="dropdown">
  ...
  <p>&nbsp;</p>
        ...
        <td align="left"><button type="button" class="btn btn-primary">Buscar</button></td>
    </form>
    <p>&nbsp;</p>
	<form>
	<table class="table table-bordered" width="500" height="300" border="0" cellspacing="0" cellpadding="0" align="center">
 	 	<tbody>
  	 		<tr>
      			<th>Id Gondola</th>
      			<th>Cap Total</th>
     		 	<th>Stock Real</th>
      			<th>Productos extraños</th>
   	 		</tr>
   	 		<tr>
      			<td>001</td>
      			<td>100</td>
