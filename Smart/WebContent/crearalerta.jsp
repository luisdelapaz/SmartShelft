...
<div class="nav-links">	
  ...
  <tbody>
    ...
    <tr>
    	<td></td>
    	<td>
    	<button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal">Crear Alerta</button>
    		...
    		<div class="contenedor-modal">
    			<div id="myModal" class="modal fade" role="dialog">
    				<div class="modal-dialog">
    					...
    					<h4><span class="glyphicon glyphicon-question-sign"></span>¿Esta seguro de crear la alerta?</h4>
    					</div>
    							...
    							<div class="contenedor-modal">
    								<div id="myModal2" class="modal fade" role="dialog">
    									<div class="modal-dialog">
    										...
    										<div class="modal-content">
    										<div class="modal-body">
    											<h4><span class="glyphicon glyphicon-ok-sign"></span>La alerta ha sido creada exitosamente</h4>
    										</div>
    										<div class="modal-footer">
